...
const translations = {
  en: {
    ...
    validationTooSoon: "Please book at least 2 hours in advance.",
  ...
  sk: {
    ...
    validationTooSoon: "Rezerváciu je potrebné urobiť aspoň 2 hodiny vopred.",
